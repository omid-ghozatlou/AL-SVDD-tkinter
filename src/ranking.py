...
# @click.argument('test_data_path', default='D:/Omid/UPB/SVM/Galaxy-classification-master/data/california/train.csv',type=click.Path(exists=True))
...
@click.option('--n_epochs', type=int, default=10, help='Number of epochs to train.')
...
@click.option('--ae_lr_milestone', type=int, default=0, multiple=True,
              help='Lr scheduler milestones at which lr is multiplied by 0.1. Can be multiple and must be increasing.')
@click.option('--ae_batch_size', type=int, default=10, help='Batch size for mini-batch autoencoder training.')
...
def main(xp_path, path, train_data_path, apply_model_data_path, load_config=None, load_model=None, objective='one-class', nu=0.1, device='cuda', seed=-1,
    ...
    # Load data
    dataset = load_dataset(train_data_path, apply_model_data_path, normal_class)   
